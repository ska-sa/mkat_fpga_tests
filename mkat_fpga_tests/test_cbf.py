    ...
    def _test_report_config(self, verbose):
        ...
        def get_src_dir():
            ...
            return {
                    ...
                    katcp_name: [katcp_dir, [katcp_version, katcp_link]],
    ...
    def _test_data_product(self, instrument, _baseline=False, _tiedarray=False):
        ...
        if  _baseline and _tiedarray:
            try:
                ...
                baseline_ch_bw = bw / test_dump['xeng_raw'].shape[0]
    ...
    def _test_beamforming(self):
        ...
        for beam in beams[0]:
            ...
            def get_beam_data(beam, beam_dict=None, inp_ref_lvl=0, beam_quant_gain=1, 
                ...
                while retries < max_cap_retries:
                    ...
                    try:
                        ...
                        # The beam weights have alreajdy been set.
                        beam_dict = None
                        if len(in_wgts) == 0:
                            in_wgts = act_wgts
                    except Exception as e:
            ...
            try:
                ...
                for substream in range(substreams-14):
