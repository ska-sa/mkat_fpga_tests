    ...
    def _new_test_config_file(self):
        ...
        try:
            ...
            if curr_inst.find('bc8n856M1k') != -1:  # if 'bc8n856M1k' is found in curr_inst for SITE
                ...
                conf_path = "config/test_conf_site_bc8n107M1k.ini"
            elif curr_inst.find('bc8n107M4k') != -1:
                conf_path = "config/test_conf_site_bc8n107M4k.ini"
            elif curr_inst.find('bc8n107M32k') != -1:
                conf_path = "config/test_conf_site_bc8n107M32k.ini"
            elif curr_inst.find('bc8n54M1k') != -1:
                conf_path = "config/test_conf_site_bc8n54M1k.ini"
            elif curr_inst.find('bc8n54M4k') != -1:
                conf_path = "config/test_conf_site_bc8n54M4k.ini"
            ...
            elif curr_inst.find('bc128n107M1k') != -1:
                conf_path = "config/test_conf_site_bc128n107M1k.ini"
            elif curr_inst.find('bc128n107M4k') != -1:
                conf_path = "config/test_conf_site_bc128n107M4k.ini"
            elif curr_inst.find('bc128n107M32k') != -1:
                conf_path = "config/test_conf_site_bc128n107M32k.ini"
            elif curr_inst.find('bc128n54M1k') != -1:
                conf_path = "config/test_conf_site_bc128n54M1k.ini"
            elif curr_inst.find('bc128n54M4k') != -1:
                conf_path = "config/test_conf_site_bc128n54M4k.ini"
