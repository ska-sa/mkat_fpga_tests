...
extensions = ["sphinx.ext.autodoc", "sphinx.ext.todo", "sphinx.ext.ifconfig", "sphinx.ext.mathjax"]
...
try:
    ...
    _filename = "MeerKAT_CBF_%s_%s.tex" % (
        _document_data.get("document_type").keys()[0],
