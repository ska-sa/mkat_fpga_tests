...
# sphinx-quickstart on Thu Jun  4 17:11:23 2009.
#
...
html_title = "CAM Integration Tests"
...
htmlhelp_basename = 'CAMtestresults'
...
latex_documents = [
  ('index', 'katdoc.tex', u'CAM Integration Tests', u'SKA SA CAM Team', 'manual'),
]
...
# -- To generate automatic references --------------------------------------------------------------

# Code snippet to generate automatic references to Trac/Mantis
# 25 November 2011

trac_url = 'https://katbuild.kat.ac.za/'
# mantis_url = 'https://katfs.kat.ac.za/mantis'
