...
sanitytest:
	@bash -c ". .venv/bin/activate; echo 'backend: agg' > matplotlibrc; nosetests -sv --logging-level=FATAL mkat_fpga_tests/test_cbf.py:test_CBF.test_imaging_data_product_set"
