...
sanitytest:
	@bash -c ". .venv/bin/activate; echo 'backend: agg' > matplotlibrc; nosetests -sv --with-xunit --with-html --with-katreport --logging-level=FATAL mkat_fpga_tests/test_cbf.py:test_CBF.test_imaging_data_product_set"
